...
# parse xml file ito a variable
tree = ET.parse("C://Users//bhash//PycharmProjects//PythonAdvanceProgramming//Dataformats//employee.xml")
root = tree.getroot()
print(root.tag)
...
tree.write(
    "C://Users//bhash//PycharmProjects//PythonAdvanceProgramming//Dataformats//writexml.xml",
    encoding="utf-8",
...
# ---------- FIX (only this block added) ----------
try:
    tree = ET.parse("C://Users//bhash//PycharmProjects//PythonAdvanceProgramming//Dataformats//updatexml.xml")
    root = tree.getroot()
...
tree.write(
    "C://Users//bhash//PycharmProjects//PythonAdvanceProgramming//Dataformats//updatexml.xml",
    encoding="utf-8",
    xml_declaration=True
)
